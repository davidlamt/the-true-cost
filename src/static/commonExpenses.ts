...
const commonExpenses: ICommonExpense[] = [
  ...
  },
  {
    ...
    monthlyCost: 92,
    description:
      'According to [this article](https://www.fool.com/retirement/2018/01/22/one-third-of-americans-spend-more-on-coffee-than-o.aspx), the average American spends around $92 a month on coffee. Maybe you should consider buying your own [coffee maker](https://amzn.to/2VbtJJE)?\n\nUsing coffee as an excuse to hang out with coworkers? Try taking a nice stroll together instead (seriously). Using it to keep yourself awake? Keep in mind that there is a diminishing effect - consider cycling it and / or making your own [green tea](https://amzn.to/3hOsk5L)!',
  },
  {
    name: 'Phone',
    ...
    monthlyCost: 99,
    description:
      'According to [this article](https://www.cnbc.com/2019/10/25/you-can-save-up-to-268-a-year-by-switching-your-cell-phone-plan.html), the average American spends around $99 a month on cell phone bills. Maybe you should consider switching to a pay-as-you-go plan like [Google Fi](https://g.co/fi/r/21U088)?\n\nMost of cost of phone bills lie with data usage. Many plans offer unlimited data - do you _really_ need that? With the wide availability of WiFi nowadays and a bit of diligence on your part, you could drastically reduce data usage.',
  },
  {
    name: 'Car',
